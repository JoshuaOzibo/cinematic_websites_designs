...
export function Story() {
  return (
    <section id="story" className="relative bg-[#F7F4EE] text-[#1F1C18] py-16 sm:py-24 px-5 sm:px-8 lg:px-12 overflow-hidden">
      ...
      <div className="mx-auto max-w-[1320px] grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
        ...
        <Reveal className="flex flex-col">
          {/* Kicker */}
          <div className="flex items-center gap-3 text-[0.75rem] font-bold tracking-[0.22em] uppercase text-[#6E675E]">
            <span className="text-[#8B1E1E] font-display text-[0.95rem]">01</span>
            <span className="text-[#C9A24B]/60">|</span>
            <span>THE HOUSE</span>
          </div>

          {/* Main Headline */}
          <h2 className="font-display mt-6 text-[2.8rem] sm:text-[3.6rem] lg:text-[4.2rem] leading-[1.04] tracking-tight text-[#1A1815]">
            Where the night <br />
            feels like <br />
            <span className="italic font-normal text-[#8B1E1E]">royalty.</span>
          </h2>
          ...
          {/* Body Copy */}
          <div className="space-y-4 max-w-[36rem] text-[0.98rem] sm:text-[1.05rem] leading-relaxed text-[#4A453E]">
            <p>
          ...
          {/* 3 Stat Columns */}
          <div className="mt-12 grid grid-cols-3 gap-2 sm:gap-6 pt-6 border-t border-[#E2D9CC] max-w-[38rem]">
            {/* Stat 1 */}
            <div className="flex flex-col pr-2 sm:pr-4">
              <div className="flex items-center gap-1.5 text-[#C9A24B] mb-2">
                <Crown className="h-4 w-4" />
              </div>
              <span className="font-display text-[2.2rem] sm:text-[2.8rem] leading-none font-medium text-[#8B1E1E]">
                02
              </span>
              <div className="mt-3 flex flex-col text-[0.62rem] sm:text-[0.68rem] font-bold tracking-[0.16em] uppercase text-[#6E675E]">
                <span>MENU</span>
            ...
            {/* Stat 2 */}
            <div className="flex flex-col px-2 sm:px-4 border-l border-[#E2D9CC]">
              <div className="flex items-center gap-1.5 text-[#6E675E] mb-2">
                <svg className="h-4 w-4 stroke-[#8B1E1E]" fill="none" viewBox="0 0 24 24" strokeWidth="1.8">
            ...
            {/* Stat 3 */}
            <div className="flex flex-col pl-2 sm:pl-4 border-l border-[#E2D9CC]">
              <div className="flex items-center gap-1.5 text-[#6E675E] mb-2">
                <svg className="h-4 w-4 stroke-[#8B1E1E]" fill="none" viewBox="0 0 24 24" strokeWidth="1.8">
                  <path d="M8 2h8v3H8zM9 5v3L6 12v9a1 1 0 001 1h10a1 1 0 001-1v-9l-3-4V5" />
                </svg>
              </div>
              <span className="font-display text-[1.6rem] sm:text-[2.2rem] leading-none font-medium text-[#8B1E1E] whitespace-nowrap">
                ₦500 – ₦1M
              </span>
              <div className="mt-3 flex flex-col text-[0.62rem] sm:text-[0.68rem] font-bold tracking-[0.16em] uppercase text-[#6E675E]">
          ...
          <div className="mt-12 pt-6 border-t border-[#E2D9CC] flex items-center gap-3 text-[0.7rem] sm:text-[0.75rem] font-bold tracking-[0.24em] uppercase text-[#7E776D]">
        ...
        <Reveal delay={160} className="w-full flex justify-center lg:justify-end">
          ...
          <div className="relative p-2.5 sm:p-3.5 rounded-t-[200px] sm:rounded-t-[260px] border border-[#C9A24B]/40 bg-[#F7F4EE] shadow-[0_25px_60px_-15px_rgba(0,0,0,0.12)] w-full max-w-[540px]">
