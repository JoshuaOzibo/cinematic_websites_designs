...
// Elevated dark, not base: hero(cream) -> story -> menu reads as a two-step
// descent into the room rather than one flat slab.
export function Story() {
  return (
    <section id="story" className="grain relative bg-background-elevated text-foreground">
          ...
          <div className="mt-9 flex flex-wrap gap-x-10 gap-y-5">
            {[
              ...
              <div key={stat.label}>
                ...
                <p className="label-track mt-2 text-[0.65rem] font-semibold text-muted-foreground">
                  {stat.label}
                </p>
              </div>
            ))}
